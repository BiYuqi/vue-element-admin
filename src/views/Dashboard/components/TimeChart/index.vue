...
export default {
  ...
  mounted () {
    ...
    this.timeTicket = setInterval(() => {
      ...
      this.options.series[0].data[0].value = (hoursAll).toFixed(2)
      this.options.series[1].data[0].value = (monthss).toFixed(2)
      this.options.series[2].data[0].value = (hoursHalf).toFixed(2)
      this.options.series[3].data[0].value = (minutes).toFixed(2)
      this.options.series[4].data[0].value = (seconds).toFixed(2)
    }, 1000)
